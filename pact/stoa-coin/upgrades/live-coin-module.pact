;; ============================================================================
;; live-coin-module.pact — REFERENCE SNAPSHOT (not compiled, not deployed)
;; ----------------------------------------------------------------------------
;; Captured: 2026-04-19
;; Source:   live mainnet `coin` module on `node1.stoachain.com` /
;;           `node2.stoachain.com` (fetch with `describe-module` to get the
;;           current authoritative copy).
;; Why it exists: documentation / audit reference for what the module looks
;;           like on-chain AFTER the first post-genesis governance upgrade
;;           (the UrStoaVault bug-fix upgrade). See ../upgrades/README.md.
;;
;; DO NOT edit new-coin.pact to match this file, and DO NOT regenerate the
;; genesis payloads from this file. The genesis source must stay byte-frozen
;; so that any new node computing block 0 from its compiled-in payloads
;; produces the same block-0 hash as the live network.
;; ============================================================================
